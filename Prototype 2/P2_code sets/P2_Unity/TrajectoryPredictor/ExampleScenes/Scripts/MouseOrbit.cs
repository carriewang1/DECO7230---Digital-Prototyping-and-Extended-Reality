...
/*
The code snippet (5. Display the text with the prediction object of user hit ) below has been sourced from
...
// End code snippet (5. Display the text with the prediction object of user hit)